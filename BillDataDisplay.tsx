...
export const BillDataDisplay: React.FC<BillDataDisplayProps> = ({ data, setData, onReset, showConfidenceWarning }) => {
  ...
  const formActionUrl = formspreeId ? `https://formspree.io/f/${formspreeId}` : '';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        ...
                        <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                            The AI has low confidence in the accuracy of the extracted data, likely due to image quality. Please carefully review and edit all fields.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <form 
            ...
            className="no-print"
        >
            <input type="hidden" name="billData" value={JSON.stringify(data, null, 2)} />
            ...
            <div className="flex flex-col md:flex-row gap-4 pt-4">
                 ...
                 <button 
                    type="submit" 
                    disabled={!formActionUrl}
                    className="flex-1 px-4 py-3 text-sm font-medium text-white bg-sky-600 rounded-lg hover:bg-sky-700 transition-colors disabled:bg-slate-400 disabled:dark:bg-slate-600 disabled:cursor-not-allowed"
                >
                    {formActionUrl ? 'Submit Form' : 'Configure Form ID to Submit'}
                 </button>
            </div>
        </form>
    </div>
