...
const InputField: React.FC<{label: string; id: keyof AiSettings; value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; type?: string; placeholder?: string; description?: string}> = 
